      ...
      $mail = new PHPMailer(true);
        try {
          ...
          //  $mail->SMTPDebug = SMTP::DEBUG_SERVER;                    //Enable verbose debug output
            ...
            //Recipients
            $mail->setFrom($code);
            $mail->addAddress($code);

            //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Password Reset';
                $mail->Body    = 'Hi there,<br/><br/>Forgot your password?<br/><br/>To reset your password, click a link below:<br/><b><a href="http://localhost/try-1/change-password.php?reset='.$otp.'">Password Reset Link</a></b><br/><br/>Otherwise, if you did not make this request then please ignore this email.';
