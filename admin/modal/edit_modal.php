...
<div class="row g-3">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" placeholder="Email" id="edit_emailaddress" name="emailaddress"  aria-label="Last name">
  </div>
</div>
<div class="row g-3">
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" placeholder="Password" id="edit_password" name="password" aria-label="Last name">
  </div>
</div>
            </div>
          </div>
