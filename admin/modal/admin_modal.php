...
last_name             }else if(last_name === ""){
           ...
           data.append('photo', $('#chooseFile')[0].files[0]);
            ...
            if(isValidFullname() === true  &&isValidmiddlename() === true  &&isValidlastname() === true  && isValidEmail() === true && isValidUsername() === true && isValidPassword() === true && isValidPhoto() === true && isValidPhoto() === true){
